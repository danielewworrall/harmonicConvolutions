...
##### MODELS #####
def deep_complex_bias(x, drop_prob, n_filters, n_rows, n_cols, n_channels, size_after_conv, n_classes, bs, phase_train, std_mult, filter_gain=2.0, use_batchNorm=True):
